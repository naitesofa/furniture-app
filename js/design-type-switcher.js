...
(function(){
  const DESIGN_TYPES = [
    ...
    { key: 'text2img', label: '文生图模式', desc: '文字描述生成图像', icon: `<svg width="28" height="28" viewBox="0 0 28 28" fill="none"><path d="M5 7h18M5 12h12M5 17h8" stroke="#2a9d8f" stroke-width="2.2" stroke-linecap="round"/><rect x="18" y="15" width="6" height="6" rx="1" stroke="#2a9d8f" stroke-width="2.2"/></svg>` }
  ];
